...
<body>
	...
	<div class="container forgecontainer">
		<div id="navigation">
			<a id="homeLink" name="homeLink" href="index.xhtml">
				<img src="<c:url value="/resources/forge-logo.png"/>" alt="Forge... get hammered" border="0" />
			</a>
			<ul>
				<li>
					<a href="<c:url value="/customer/search"/>">Customer</a>
				</li>
			</ul>
		</div>
